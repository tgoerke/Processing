...
void draw(){
  ...
  if(ballY > (height - 40)){                                 //If the ball reaches the top it will decelerate
    speedY = -speedY;
    float distance = abs(paddleX - ballX);
 ...
 /////////////////////////////////////////////Paddle Properties/////////////////////////////////////////////
 //Here I create a paddle that tracks to the paddleX position. 
 ...
 //I then create the shinkinking effect with the width of the rectangle
  fill(0);
  rect(paddleX - paddle, height - 10, 2*paddle, 10);    
...
//ball can be difficult to see with a black paddle. 
  fill(250);
  rect(paddleX - paddle + 10, height - 10, 2*paddle - 20, 4);
  fill(250);
  textSize(15);
